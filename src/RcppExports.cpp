...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(mcmc_iter(total_step, w_step, r_pace, w_pace, n_mh, ng_test, ni_test, h_max, h_min, h_scale, logp_max, logp_min, logp_scale, y, z_hat, z, rank_old, beta_old, beta_new, Xtz_old, Xtz_new, Xb_old, Xb_new, p_gamma, pos_vec, cHyp_old, X, Xgamma_old, Xgamma_new, XtX_old, XtX_new, Result_hyp, Result_gamma, beta_g, display_progress));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_hello_world
List rcpp_hello_world();
RcppExport SEXP _fabio_rcpp_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fabio_mcmc_iter", (DL_FUNC) &_fabio_mcmc_iter, 35},
    {"_fabio_rcpp_hello_world", (DL_FUNC) &_fabio_rcpp_hello_world, 0},
    {NULL, NULL, 0}
};
